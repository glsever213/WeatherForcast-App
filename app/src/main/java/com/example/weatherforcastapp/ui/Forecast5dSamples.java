...
public final class Forecast5dSamples {
    ...
    public static List<DailyForecastAdapter.Slot> defaultSlots() {
        ...
        daily.add(new DailyForecastAdapter.Slot("13/9", "21°", "Mưa giông", "389", "80%", "21°"));
        daily.add(new DailyForecastAdapter.Slot("14/9", "34°", "Nắng", "113", "80%", "21°"));
        daily.add(new DailyForecastAdapter.Slot("15/9", "30°", "Nhiều mây", "119", "80%","21°"));
        daily.add(new DailyForecastAdapter.Slot("16/9", "28°", "Âm u", "122", "80%", "21°"));
        daily.add(new DailyForecastAdapter.Slot("17/9", "27°", "Mưa nhẹ", "116", "80%", "21°"));
        return daily;
    }
}
